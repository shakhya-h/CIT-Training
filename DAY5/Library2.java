...
class Book2 extends LibraryItem {
    private String author;

    public Book2(String title, int itemId, Double price, String author) {
...
class Magazine2 extends LibraryItem {
    private String issueMonth;

    public Magazine2(String title, int itemId, Double price, String issueMonth) {
        super(title, itemId, price);
        ...
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    items.add(new Book2(bTitle, bId, bPrice, author));
                ...
                case 2:
                    ...
                    items.add(new Magazine2(mTitle, mId, mPrice, month));
